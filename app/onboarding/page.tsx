...
export default function OnboardingPage() {
  ...
  /*
   * UploadThing uploadFiles() returns
   ...
   * - url
   *
   * We use the returned URL directly.
   */
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const [
        ...
        uploadFiles("documentUploader", {
          files: [formData.files.ssn!],
        }),

        uploadFiles("documentUploader", {
          files: [formData.files.license!],
        }),

        uploadFiles("documentUploader", {
          files: [formData.files.registration!],
        }),

        uploadFiles("documentUploader", {
          files: [formData.files.insurance!],
        }),

        uploadFiles("documentUploader", {
          files: [formData.files.check!],
        }),
      ]);
      ...
      const [
        ...
        uploadFiles("photoUploader", {
          files: [formData.photos.front!],
        }),

        uploadFiles("photoUploader", {
          files: [formData.photos.driverSide!],
        }),

        uploadFiles("photoUploader", {
          files: [formData.photos.passengerSide!],
        }),

        uploadFiles("photoUploader", {
          files: [formData.photos.rear!],
        }),
      ]);

      /*
       * GET REAL UPLOADTHING URLS
       */
      ...
      const uploadedUrls = {
        ...
        check: getUploadedUrl(
          checkRes
        ),

        front: getUploadedUrl(
          frontRes
        ),
      ...
      /*
       * CHECK THAT EVERY UPLOAD RETURNED
       * A REAL URL
       */
